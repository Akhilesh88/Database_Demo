...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createonobj() {
        NeditText1 = findViewById(R.id.NeditText); //name
        MeditText2 = findViewById(R.id.MeditText); //marks
        ReditText3 = findViewById(R.id.ReditText); //rollno
        abutton = findViewById(R.id.add);
        dbutton = findViewById(R.id.delete);
        mbutton = findViewById(R.id.modify);
        vbutton = findViewById(R.id.view);
        vabutton = findViewById(R.id.viewall);
        abbutton = findViewById(R.id.about);
    }
